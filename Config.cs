...
public class Config
{
    ...
    {
        Program.ConsoleWarning(">> Reading Config.ini file.");
        ...
        if (configFile.Exists == false)
        {
            ...
            Program.ConsoleWarning("Missing required info in Config.ini file." + Environment.NewLine + "The file was generated." + Environment.NewLine + "Please fill it up.");
            Console.ReadLine();
            return true;
        }
        else
